...
public class MoveItemOnlySlideHandler extends MoveBaseSlideHandler {

    public MoveItemOnlySlideHandler() {
        super();
    }
    ...
    public MoveItemOnlySlideHandler(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
