...
public class MoveContentOnlySlideHandler extends MoveBaseSlideHandler {

    public MoveContentOnlySlideHandler() {
        super();
    }
    ...
    public MoveContentOnlySlideHandler(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
