...
public class SlideSupportScrollView extends ScrollView
    ...
    public SlideSupportScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initLayout(context, attrs);
    }

    public SlideSupportScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void bindSlideLayout(SlideSupportLayout layout) {
        layout.setSlideSupporter(mActionHandler);
    }
