...
public class RecyclerViewSampleActivity extends ModeSwitchableSampleActivity {

    protected RecyclerViewSampleLayout mRecyclerLayout;
    ...
    public void setFavViewBkgColorResId(int colorResId) {
        mRecyclerLayout.setFavViewBkgColorResId(colorResId);
    }
}
