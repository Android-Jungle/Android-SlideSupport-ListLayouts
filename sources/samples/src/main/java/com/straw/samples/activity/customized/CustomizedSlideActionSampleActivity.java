...
import com.straw.samples.activity.layout.CustomizedSlideActionLayout;

public class CustomizedSlideActionSampleActivity
        extends ModeSwitchableSampleActivity {

    private CustomizedSlideActionLayout mRecyclerLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customized_slide_action_handler);
        mRecyclerLayout = (CustomizedSlideActionLayout)
